...
export const products: Product[] = [
  {
    ...
    sizes: ["OS"],
    stock: { OS: 24 },
    image: "/images/frnkplus-exclusive-streetwear-cap.webp",
    gallery: ["/images/frnkplus-exclusive-streetwear-cap.webp", "/images/frnkplus-cap-jacket.jpg", "/images/frnkplus-black-studio.jpg"],
