  ...
  return (
    <main className="min-h-screen bg-[var(--frnk-black)] text-white">
      ...
      <section className="relative isolate min-h-[calc(100svh-4rem)] overflow-hidden sm:min-h-[calc(100svh-4.5rem)]">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(248,246,242,0.34)_0%,rgba(248,246,242,0.08)_34%,#f8f6f2_100%),linear-gradient(90deg,#f8f6f2_0%,rgba(248,246,242,0.72)_38%,rgba(248,246,242,0.14)_100%)]" />
      ...
      <section className="border-y border-white/10 bg-[#f2eee9] px-5 py-12 sm:px-8 sm:py-14 lg:px-10">
      ...
      <section className="px-5 py-12 sm:px-8 sm:py-16 lg:px-10">
        <div className="mx-auto grid max-w-[1680px] gap-5 lg:grid-cols-12">
          ...
          <div className="grid content-between gap-8 border border-white/10 bg-[#f0ebe5] p-5 sm:gap-10 sm:p-8 lg:col-span-5">
            <div>
